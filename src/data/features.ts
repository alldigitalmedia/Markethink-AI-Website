...
export const connectionGroups = [
  ...
  { title: 'Meetings & conversations', description: 'Bring the decisions from a call into the work that follows.',
    apps: [{ id: 'zoom', context: 'Meeting recording' }, { id: 'google-meet', context: 'Meeting recording' }, { id: 'microsoft-teams', context: 'Meeting recording' }, { id: 'webex', context: 'Meeting recording' }, { id: 'whatsapp', context: 'Customer inbox' }],
